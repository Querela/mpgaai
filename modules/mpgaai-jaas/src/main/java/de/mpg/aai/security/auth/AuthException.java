 ...
 * that provides type safety for all the security-related exception classes that
 * extend from it.
 ...
 * </li>
 * <li>in my view:
 * there is no value in forcing clients of API to handle or throw/propagate such
 * checked exceptions they cannot directly deal with.
 * it should be more a question of documentation and making it known to client
 * implementors what kind of exception they have-to expect,
 * and can POSSIBLY handle them, rather to be impelled to treat them immediately
 * </li>
 * </ul>
 * 
 * @see <a href="http://www.springsource.org/aboutspring">About Spring
 *      (Source)</a>
 * @see <a href=
 *      "http://www.onjava.com/pub/a/onjava/2003/11/19/exceptions.html">Java
 *      Exceptions</a>
 * @author megger
 */
