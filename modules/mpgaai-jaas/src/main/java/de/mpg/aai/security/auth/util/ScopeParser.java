 ...
 * instances can be used to parse repeatedly with similar default-scope (and
 * delimiter-) values
 * 
...
public class ScopeParser {
	...
	/**
	 * constructur, initializes this parser with given options, see
	 * {@link #init(Map)}
	 * 
	 ...
	 * 
	 * @param target       the value to be parsed/split
	 * @param defaultScope default value for scope if none was found in the given
	 *                     target
	 * @return String[2] of signature [unscoped-value][scope]
	 */
