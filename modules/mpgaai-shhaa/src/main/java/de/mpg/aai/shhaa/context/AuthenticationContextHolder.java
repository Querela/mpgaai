 ...
 * use {@link #get()} to retrieve the context from the application (business)
 * layer
...
public class AuthenticationContextHolder {
	...
	/**
	 * provides the AuthenticationContext instance attribute from the (session
	 * within the) given request
	 * 
	 * @param request request to lookup the AuthenticationContext in
	 * @return AuthenticationContext found in the given request's session, null if
	 *         not found
	 * @see #get(HttpSession)
	...
	/**
	 * stores the given AuthenticationContext instance (as attribute) into the given
	 * request's session
	 * 
