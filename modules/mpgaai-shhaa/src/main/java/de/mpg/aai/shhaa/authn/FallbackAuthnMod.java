 ...
 * fallback means the "anonymous"/default data when no other specific login
 * (e.g. by shibboleth/saml) could be found
 * 
 * @author megger
 *
 */
public class FallbackAuthnMod extends BaseAuthnMod implements AuthenticationModule, Configurable {
	 ...
	 */
	@Override
	public Subject initSubject(final AuthenticationContext authCtx,
