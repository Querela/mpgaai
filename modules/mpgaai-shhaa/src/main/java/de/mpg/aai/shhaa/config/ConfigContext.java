...
public class ConfigContext {
	...
	/**
	 * name/identifier to put/get this configurationContext into/from the
	 * servletContext
	 */
	...
	/**
	 * provides the current/active configuration context (expected/looked-up in the
	...
	public Configuration getConfiguration() throws ConfigurationException {
		if (this.config == null)
			throw new ConfigurationException(
					"no Configuration found - seems not initialized -> call init(URL/String) first");
		return this.config;
	}
	...
	public HttpAuthService getAuthService() throws ConfigurationException {
		if (this.authSrv == null)
			throw new ConfigurationException(
					"no authn/z service found - seems not initialized -> call init(URL/String) first");
		return this.authSrv;
	}
}
