 ...
 * overriding {@link HttpServletRequest#getRemoteUser()} and
...
public class AAIServletRequest extends HttpServletRequestWrapper {
	/**
	 * holds possible return targets for rerouting (redirect or forward) the current
	 * request to
	 */
	...
	/**
	 * @return provides possible return targets to reroute (forward|redirect) this
	 *         request to
	 */
	 ...
	 * 
	 * @param url the return target as string (can be e.g. a servlet call within a
	 *            webapp context, or a "full" url
	 */
