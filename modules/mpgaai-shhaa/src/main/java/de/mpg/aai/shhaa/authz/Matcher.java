...
/**
 * abstract base class for implementations of {@link Rule} which have a
...
public abstract class Matcher {
	...
	/**
	 * flag for matching behavior for this target (@see {@link #matches(String)}):
	 * <ul>
	 * <li>"case" - default: match case sensitive (recognizes trailing asterisk
	 * *)</li>
	 * <li>"nocase" - ignore case on matching (recognizes trailing asterisk *)</li>
	 * <li>"regex" - match as regular expression (treat target pattern as
	 * regEx)</li>
	 * </ul>
	 */
	 ...
	 * 
	 * @param mode match-mode to set, must one of defined MATCH_MODE_... constants,
	 *             see {@link Matcher}
	 ...
	 * 
	 * @param expression to match the given target by: blank string, with trailing
	 *                   asterisk or as regEx
