 ...
 * defines methods to initialize an authentication context and the (user)
 * subject
 * 
 * @author megger
 *
...
public interface AuthenticationModule {
	 ...
	 * NOTE: this method should internally already call
	 * {@link #initSubject(AuthenticationContext, HttpServletRequest)}
	 * 
	...
	/**
	 * updates or initializes (if null yet) the given authentication context's
	 * Subject with the proper user
	 * 
